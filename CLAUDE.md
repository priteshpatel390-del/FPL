...
## Current checkpoint
Stage 10.1 — Deadline-safe snapshot foundation is complete and merged through PR #27 at `da76c81f552fd9da5c518e73ccc0fbe966c74444` after owner acceptance on iPhone. Startup silently verifies the approved source set, presents one consistent dataset and dispatches eligible deadline evidence without delaying access; recovery imports remain non-official. Verified source `eb3497ec405d6c7b8ce09105614fcb8280abc34b` passes **349/349 tests** with a successful production build, byte-identical two-build output and exact build identity; generated artefacts are committed at `1259e7b5f7505d3330c772e89c77720251552287`. The next checkpoint is **Stage 10.2 — Official outcome collection**, at investigation and exact-scope confirmation only; no Stage 10.2 implementation has begun. No model formula, provider blend, calibration, captaincy, squad or optimiser objective changed.
