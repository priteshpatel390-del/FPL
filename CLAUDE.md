...
## Read in this order
1. `docs/UX-A1-MERGE-RECORD.md` for the current merged checkpoint and supersession note
...
## Current checkpoint
UX-A1 Team Resources and Bench Clarity is complete and merged through PR #74 at `15aa01a07a5645f5df9ec2f2f429aefa52965c94`. Its approved branch head and merge commit have the same repository tree. The accepted automated baseline is **624 passed, 0 failed, 0 skipped**, with deterministic exact-identity builds and root `index.html` equal to `dist/index.html`. Populated iPhone Safari acceptance passed on 6 August 2026. VoiceOver testing is not a project acceptance requirement. FPL-T1 and Track A remain complete and merged through PRs #69, #70 and #72. Current operational work is pre-season readiness and prospective 2026/27 evidence collection. Workstreams A2, A3, Track B and every provider/model change remain unapproved; begin any later development with investigation, exact scope and Pritesh's explicit approval.
...
- No A2, A3, Track B, optimiser, football-model, ranking or provider work is approved without a new explicit gate.
