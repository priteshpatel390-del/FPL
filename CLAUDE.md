...
## Read in this order
1. `docs/UX-A2-SCOPE.md` for the current approved item, then `docs/UX-A1-MERGE-RECORD.md` for the last merged checkpoint and its supersession note
...
## Current checkpoint
UX-A1 Team Resources and Bench Clarity is complete and merged through PR #74 at `15aa01a07a5645f5df9ec2f2f429aefa52965c94`. Its approved branch head and merge commit have the same repository tree. The accepted automated baseline is **624 passed, 0 failed, 0 skipped**, with deterministic exact-identity builds and root `index.html` equal to `dist/index.html`. Populated iPhone Safari acceptance passed on 6 August 2026. VoiceOver testing is not a project acceptance requirement. FPL-T1 and Track A remain complete and merged through PRs #69, #70 and #72. Current operational work is pre-season readiness and prospective 2026/27 evidence collection. The current approved item is UX-A2 Player Detail Scroll and Rotation Correction, implemented for review on draft PR #76 and awaiting populated physical iPhone Safari acceptance. Workstreams A3, Track B and every provider/model change remain unapproved; begin any later development with investigation, exact scope and Pritesh's explicit approval.
