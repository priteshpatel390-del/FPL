...
function operatingReviewCsvSchemas(bundle){ return {...operatingReviewPrimaryCsvSchemas(bundle),...operatingReviewTransferCsvSchemas(bundle)}; }
function buildOperatingReviewCsv(bundle,tableName){
  const schemas=operatingReviewCsvSchemas(bundle),schema=schemas[tableName]; if(!schema) throw new Error('CSV table is not supported');
