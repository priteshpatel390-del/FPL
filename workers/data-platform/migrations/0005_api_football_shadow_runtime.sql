...
CREATE TABLE api_football_runtime_state (
 ...
 quota_state TEXT NOT NULL DEFAULT 'UNOBSERVED' CHECK(quota_state IN ('UNOBSERVED','PROBE_REQUIRED','KNOWN','QUOTA_UNCERTAIN','BLOCKED_429','AUTH_BLOCKED','CEILING_REACHED')),
...
CREATE TABLE api_football_request_attempts (
 ...
 completed_at TEXT, outcome TEXT NOT NULL CHECK(outcome IN ('RESERVED','SUCCEEDED','HTTP_FAILURE','TIMEOUT','TRANSPORT_UNKNOWN','SCHEMA_FAILURE','QUOTA_BLOCKED','AUTH_FAILURE')),
