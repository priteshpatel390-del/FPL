...
export async function runE2LiveContract(options){
  ...
  const startedAt=timestamp(options.startedAt),endedAt=timestamp(options.endedAt);if(Date.parse(endedAt)<Date.parse(startedAt))stop('e2_evidence_timestamp_invalid');
