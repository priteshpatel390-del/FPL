...
/** SQL literals are emitted only for the closed repository table allowlist. */
export function quoteE2SchemaTableLiteral(table){
  if(!E2_APPROVED_TABLES.includes(table))throw new Error('e2_schema_table_not_approved');
