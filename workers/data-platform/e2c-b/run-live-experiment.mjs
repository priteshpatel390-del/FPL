...
try{
  ...
  const approvedAccountFingerprint=fingerprint('CLOUDFLARE_E2C_APPROVED_ACCOUNT_FINGERPRINT'),productionAccountFingerprint=fingerprint('PRODUCTION_ACCOUNT_FINGERPRINT');
