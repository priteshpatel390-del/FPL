...
- [GW1-P1 Cloudflare Evidence Foundation](GW1-P1-CLOUDFLARE-EVIDENCE-FOUNDATION.md) — approved backend-only predeadline evidence-custody foundation: separate authenticated Worker, private R2-first archive, minimal D1 manifest/receipt layer, fail-closed optional-provider retention gates and recovery/reconciliation contract; client integration and deployment acceptance remain separate checkpoints.
