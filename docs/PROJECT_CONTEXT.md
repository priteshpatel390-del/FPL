...
<!-- UX-A2-2026-08-06 -->
> **UX-A2 Player Detail Scroll and Rotation Correction — approved implementation in review:** branch `agent/ux-a2-player-detail-scroll-rotation` (draft PR #76) is based on verified `main` `2738a0500b9be20a723f0940df0a93766b29c05d`. It corrects how the existing Player Detail dialog scrolls, locks the background, restores the page position and sizes itself when a phone rotates. Player Detail's information architecture, the routing architecture and every calculation are unchanged. Verification is **643 passed, 0 failed, 0 skipped** with deterministic production outputs. Populated physical iPhone Safari review remains owner-pending, so the draft PR must not be merged. UX-A3 and Workstream B remain outside scope and unapproved. See `UX-A2-SCOPE.md`.
...
> **Teamsheet 2.0.7:** Complete and merged through PR #68. Its Safari foreground-resume correction passed owner retest. Subsequent FPL-T1 and Track A work is merged through PRs #69, #70 and #72 at final `main` `be742e1eb707b3892f6405adf5d8769e084eee65`. VoiceOver remains accepted-unverified.

Purpose: master overview — the first document any new developer or session reads after CLAUDE.md.
Audience: anyone joining the project. Last updated: 2026-08-06. Related: ARCHITECTURE.md, ROADMAP.md, DECISIONS.md, TEAMSHEET2-PRODUCT-BLUEPRINT.md.
...
## Current status
- FPL-T1 and Track A are complete and merged through PRs #69, #70 and #72; final `main` is `be742e1eb707b3892f6405adf5d8769e084eee65` and has the exact verified PR #72 tree `3794e8e7ab9859717950296766dc9d64c9e5473f`. Accepted verification: **613 passed, 0 failed, 0 skipped**, deterministic builds and populated iPhone Safari acceptance for the tested Transfers paths.
...
Current development item: **no new implementation checkpoint is approved.** FPL-T1 and Track A are merged through PRs #69, #70 and #72 at `be742e1eb707b3892f6405adf5d8769e084eee65`. Current work is pre-season readiness, live operational checks and prospective 2026/27 evidence collection. Full populated acceptance outside the tested Transfers paths remains separately tracked. Any new product, provider, model or Track B work requires investigation, an exact scope and Pritesh's explicit approval.
