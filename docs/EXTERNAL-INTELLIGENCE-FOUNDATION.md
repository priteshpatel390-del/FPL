...
# EIA-1 superseding qualification (30 August 2026)

The earlier TheSportsDB research position has now been rechecked and bounded by [EIA-1 Expected-Minutes Evidence Activation](EXTERNAL-INTELLIGENCE-EIA1-XMINS-EVIDENCE.md). The source is classified `local_research_only` and FAIL for expected-minutes workload evidence; no durable provider-fact retention or production use is approved.
