...
The E2A suite pins disposable-identity rejection, atomicity and reconciliation plans, direct-string and JSON-null affinity cases, exact 1/10/24/35/40 statement profiles, exact five body-byte profiles, the synthetic 9,860-write analogue, injected-transport-only operation, one-dispatch/no-retry classifications and sanitized evidence. This coverage validates deterministic machinery only, not live Cloudflare behaviour. See [E2A record](../workers/data-platform/DATA-S2B-E2A-REPOSITORY-D1-REST-VALIDATION.md).
