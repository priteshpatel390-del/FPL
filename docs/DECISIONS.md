...
Evidence: 781 tests pass (693 retained unweakened, 88 added). Deterministic double build byte-identical; root/deployable equality; exact manifest identity. Physical iPhone Safari acceptance has not been performed and is not claimed.
