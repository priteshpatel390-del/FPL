...
| REFRESH-3 | Refresh-Load R1 lacks physical iPhone live/cached/stale/offline acceptance | Automated request, cache, provider, security and full-suite evidence cannot establish real Safari latency or foreground behaviour | R1 draft review | Open (merge gate) |
