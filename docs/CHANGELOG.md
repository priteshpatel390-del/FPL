...
### Changed
- Every approved Stage 3.5 dynamic rendering surface now uses DOM nodes: gameweek/source status, ticker, players and breakdowns, squad/captaincy, transfers, leagues, manual squad/search and backtest output.
### Unchanged
...
## [2.0.0-docs] — 2026-07-26
### Added
- `/docs` system and root CLAUDE.md onboarding; repository declared source of truth.
### Fixed
- Misleading resilience-test title around malformed duplicate fixtures.

## [2.0.0] — 2026-07-26 — Stage 2
### Added
- ES-module architecture, deterministic bundler, manifest and BUILD_INFO.
- Provider registry, odds provenance and matching rules, pure backtest and versioned caches.
### Security
- Odds key direct-only and never relayed.
### Known issues
- See KNOWN_LIMITATIONS.md.

## [1.x] — 2026-07-26 — Pre-refactor product evolution
### Added
- Fixture ticker, expected-points engine, squad review, transfers, mini-league comparison, manual squad, Understat and odds layers, on-device aggregate backtest and persistence hardening.
### Fixed
- Availability discount, bonus over-projection, settings persistence and GitHub Pages filename issues.
