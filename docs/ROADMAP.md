...
- **UX-A2 Player Detail Scroll and Rotation Correction** · COMPLETE AND MERGED through PR #76 at `bffcba8e9231adfc216125913f8ab83c042c3e10`; populated iPhone Safari owner acceptance passed 6 August 2026 and the Safari rotation text-inflation defect it exposed is corrected and physically retested. Behaviour correction only; no Player Detail information redesign. See `UX-A2-MERGE-RECORD.md`.
