...
| [Availability / Team News](05-AVAILABILITY/RESEARCH-AVAILABILITY.md) | §§3.4, 7–8, 14 | Which factual injury/suspension/team-news observations are reliable, fresh and rights-safe? | Research complete | Step 6 found Sportmonks technically promising but conditional; the subsequent owner constraint rules out paid recurring subscriptions, so Sportmonks is now a research comparator rather than the intended pilot path. Stage 10/Official FPL remain the immutable production control | No lawful/reliable £0-recurring-cost factual source has yet been selected | Investigate existing approved inputs, first-party/free sources and genuinely sustainable free tiers; compare incremental value before proposing collection | Separate zero-cost factual-availability investigation and evidence-led proposal | Not approved |
...
Step 6 provider/security approval research narrowed the Sportmonks path to **GO WITH CONDITIONS** on technical/rights grounds. The owner subsequently added a **£0 recurring subscription cost** constraint, which supersedes Sportmonks as the intended next pilot path without erasing the historical research finding. The next research checkpoint is therefore a **zero-cost factual availability investigation**, not Sportmonks account/trial due diligence. No account, collection, Worker/D1 code or model effect is approved.
