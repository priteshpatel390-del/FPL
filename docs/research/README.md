...
| [Non-PL Player Workload](04-CALENDAR-WORKLOAD/RESEARCH-NON-PL-PLAYER-WORKLOAD.md) | §§3.4–3.5, 14 | Can non-PL starts/minutes/substitutions/extra time improve expected-minutes evidence? | Planned | Expected-minutes production behaviour is unchanged | Player-level competition coverage and identity mapping not established | Player starts/minutes/subs/extra time with canonical IDs and prospective outcomes | Separate expected-minutes evidence proposal | Not approved |
| [Availability / Team News](05-AVAILABILITY/RESEARCH-AVAILABILITY.md) | §§3.4, 7–8, 14 | Which factual injury/suspension/team-news observations are reliable, fresh and rights-safe? | Planned | Official FPL remains baseline availability input | Source conflicts/freshness/rights not evaluated | First-party/credible free-source comparison and conflict rules | Shadow-only source proposal | Not approved |
| [Predicted Line-ups / Start Probability](05-AVAILABILITY/RESEARCH-PREDICTED-LINEUPS.md) | §§3.4, 11–12, 14 | Can lineup predictions add calibrated evidence for `pStart`, `pAppear`, `p60`, `expMin`? | Planned | A source prediction must never become direct `pStart = 1/0` | Source reliability/disagreement/licensing not evaluated | Multi-source predictions frozen pre-deadline and compared with starts/minutes | Separate expected-minutes model proposal after prospective evidence | Not approved |
...
| [Historical Evaluation](08-HISTORICAL-EVALUATION/RESEARCH-HISTORICAL-EVALUATION.md) | §§9, 12, 15 | What historical/walk-forward evidence can validly complement prospective evaluation without leakage? | Planned | Historical correlation alone is not proof; r≈0.80 remains method-flattered | Dataset/field availability and leakage-safe reconstruction limits | Pinned datasets, chronology, ablation/calibration protocol, untouched future validation | Evaluation proposal; no automatic tuning | Not approved |
| [External Repositories](09-EXTERNAL-REPOSITORIES/RESEARCH-EXTERNAL-REPOSITORIES.md) | §§7–8, 14 | Which public repositories contain useful algorithms/contracts/tests and which assumptions are incompatible? | Planned | Named repositories are research subjects only, not dependencies | Licence/activity/code-method review not performed | Licence, maintenance, concepts, tests, incompatible assumptions | Separate adoption proposal for any concept/code | Not approved |
...
| [GW1 Evidence Readiness](11-GW1-EVIDENCE/GW1-RESEARCH-EVIDENCE-READINESS.md) | §§9, 12–13, 15 | Which pre-deadline observations are irreconstructible and what must be captured before GW1? | Awaiting evidence | Normalised Odds inputs used by production are already captured by Stage 10 when healthy; raw bookmaker history is not | Genuine eligible pre-deadline evidence does not exist yet | Timestamped/provenance-verified GW1 capture/export, then later outcomes | Real capture window and subsequent evaluation | Not approved |
