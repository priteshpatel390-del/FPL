...
**Repository test baseline: 944 tests, 944 passed, 0 failed, 0 skipped, 0 cancelled**, plus deterministic byte-identical production builds, root/deployable equality, exact build identity and verified committed build provenance. The earlier counts of 934 and 907 are historical checkpoint evidence; 907 was raised to 934 by the GW1-P2D-P1 diagnostic transport probe regressions and to 944 by the GW1-P2D-P1A settings route-activation regressions, with no change to application decision, model or provider behaviour.
