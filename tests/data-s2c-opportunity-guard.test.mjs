...
test('every member of the shared production group stays non-cancelling with no queue key',()=>{
  ...
  assert.deepEqual(members,['api-football-mapping-0006-persistence.yml','api-football-mapping-0006-recovery.yml','api-football-migration-0004.yml','api-football-migration-0005.yml','api-football-migration-0006.yml',
